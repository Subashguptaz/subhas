...
namespace subhas.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly subhasDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = subhasConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(subhasDbContext context)
        {
            _context = context;
        }
